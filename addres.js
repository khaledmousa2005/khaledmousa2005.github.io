// ========== الإعدادات العامة ==========
const WA_MAIN = "201156062656"; // رقم الواتساب الرئيسي الصحيح بتاع الخالد تك
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const waButtons = document.querySelectorAll(
    ".wh-btn, .btn.btn-primary[data-product]"
  );
  ...
  (function initServicesPage() {
    ...
    waBtn.addEventListener("click", (e) => {
      ...
      const msg = مرحبًا، أريد الاستفسار أو حجز خدمة: ${selectedService};
      const url =
        "https://api.whatsapp.com/send?phone=" +
        WA_MAIN +
        "&text=" +
